...
import 'package:rehab/features/playground_details/playground_details_response.dart';
import 'package:rehab/shared/main_app_bar/main_app_bar.dart';
import 'package:rehab/shared/custom_list_tile/custom_list_tile.dart';
...
class _PlaygroundDetailsPageState extends State<PlaygroundDetailsPage> {
  ...
  void initState() {
    ...
    locator<PlaygroundDetailsManager>().showZoomable = ShowZoomable.hide;
  }
      ...
      body: Observer<PlaygroundDetailsResponse>(
          ...
          onSuccess: (context, playgroundDetailsSnapshot) {
            return ValueListenableBuilder<ShowZoomable>(
                valueListenable: playgroundDetailsManager.showZoomableNotifier,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        StreamBuilder<String>(
                                            initialData: "",
                                            stream: playgroundDetailsManager
                                                .reservationDate.stream,
                                            builder: (context,
                                                reservationDateSnapshot) {
                                              return InkWell(
                                                onTap: () async {
                                                  print(
                                                      "XXXXXXX=> playgroundDetailsManager.emptyDays? ${playgroundDetailsManager.emptyDays}");
                                              ...
                                              builder: (context,
                                                ...
                                                return CustomAnimatedOpenTile(
                                                  ...
                                                  body: StreamBuilder<
                                                      ...
                                                      initialData: const [],
                                                      stream: playgroundDetailsManager
                                                          .availableHoursSubject
                                                          .stream,
                                                      builder: (context,
                                                          availableHoursSnapshot) {
                                                        return ListView
                                                            .separated(
                                                          separatorBuilder:
                                                              (context, index) {
                                          ...
                                          onClick: () {
                                            if (playgroundDetailsManager
                                              ...
                                              locator<ToastTemplate>().show(
                                                  "برجاء تحديد التاريخ والوقت اولا");
                                            } else {
                                              if (prefs.userObj != null) {
                                                bookingManager.booking(
                                                  ...
                                                  count: 1,
                                                  date: playgroundDetailsManager
                                                      .reservationDate.value,
                                                  // optionId: offerOrDiscountManager.optionNotifier.value,
                                                  time: playgroundDetailsManager
                                                      .reservationTime.value,
                                                  type: BookingType
                                                      .playground.name,
                                                ));
