...
import 'package:rehab/app_core/services/url_launcher/url_launcher.dart';
import 'package:rehab/features/contact_us/RegisterRequest.dart';
import 'package:rehab/features/contact_us/contact_us_manager.dart';
import 'package:rehab/features/contact_us/contact_us_response.dart';
import 'package:rehab/features/contact_us/widgets/map_widget.dart';
                                      ...
                                      Container(
                                        ...
                                        child: Center(
                                          child: ListView.builder(
                                            ...
                                            shrinkWrap: true,
                                            itemCount: contactUsInfoSnapshot.data!.socialMedia!.length,
                                            itemBuilder: (_, index) {
                                              return InkWell(
                                                  onTap: (){
                                                    openURL("${contactUsInfoSnapshot.data!.socialMedia![index].link}");
                                                  },
                                                  child: Container(
                                                    ...
                                                    child: NetworkAppImage(
                                                      imageUrl: "${contactUsInfoSnapshot.data!.socialMedia![index].icon}",
                                                    ),
                                                  ));
                                            },
                                          ),
